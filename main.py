...
with tab3:
    ...
    if view_option == "Fietsverhuur over tijd":
        ...
        try:
            ...
            # 🎯 PASSAGIERS PER STATION GRAFIEK (TOP 20)
            ...
            fig_bar = px.bar(
                ...
                x="Station",
                y="Aantal passagiers",
                title="Top 20 metrostations op basis van passagiers (in miljoenen)",
                labels={"Aantal passagiers": "Passagiers (mln)"},
                color="Aantal passagiers"
            )
