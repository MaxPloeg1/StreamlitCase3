...
with tab3:
    ...
    # === 2. BAR CHART: PASSAGIERS PER STATION ===
    try:
        passengers = pd.read_csv("2017_Entry_Exit.csv")

        top20 = passengers.sort_values(by="2017", ascending=False).head(20)
    ...
    try:
        ...
        fig_corr = px.scatter(
            ...
            labels={"tavg": "Gem. temperatuur (°C)", "2017": "Passagiers (mln)"}
        )
